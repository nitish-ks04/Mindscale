...
import re
from ai_services.nlp import analyze_text
from pydantic import BaseModel

# Import routers
from routers import emotion_routes, scoring_routes, keystroke_routes, questionary_routes
...
app.include_router(questionary_routes.router)
...
def analyze_text_api(req: NLPRequest):
