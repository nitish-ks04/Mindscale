...
Mindscale is a web application combining a React frontend, Node/Express backend, MongoDB persistence, and a Python FastAPI-based chatbot (powered by LangChain + Google Gemini). The chatbot provides helpful responses, sentiment-aware context, and conversational memory for improved continuity.
